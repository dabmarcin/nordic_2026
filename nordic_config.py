...
PORTFOLIO_SIGNALS = {
    "csl_draw": {
        ...
        "model_src": "rule",
        "typ":       "Draw",
        "condition": "odds_ft_x >= 3.30 and odds_ft_x <= 4.50",
        "odds_col":  "odds_ft_x",
        "label":     "CSL Draw 3.30-4.50",
        "tier":      "A",
    },
    "mls_away_win_hi": {
        "league":    "mls",
        "model_src": "rule",
        "typ":       "Away Win",
        "condition": "odds_ft_2 >= 3.50 and odds_ft_2 <= 5.00",
        "odds_col":  "odds_ft_2",
        "label":     "MLS Away Win 3.50-5.00",
        "tier":      "A",
    },
    "csl_home_win": {
        "league":    "csl",
        "model_src": "rule",
        "typ":       "Home Win",
        "condition": "odds_ft_1 >= 2.50 and odds_ft_1 <= 4.00",
        "odds_col":  "odds_ft_1",
        "label":     "CSL Home Win 2.50-4.00",
        "tier":      "A",
    },
    "csl_under_corners": {
        "league":    "csl",
    ...
    "veikk_draw": {
        ...
        "condition": "odds_ft_x >= 3.30 and odds_ft_x <= 4.50",
        "odds_col":  "odds_ft_x",
        "label":     "Veikkausliiga Draw 3.30-4.50",
        "tier":      "A",
    },
    "veikk_under25": {
        "league":    "veikkausliiga",
        "model_src": "rule",
        "typ":       "Under 2.5",
        "condition": "odds_ft_under25 >= 1.90 and odds_ft_under25 <= 2.20",
        "odds_col":  "odds_ft_under25",
        "label":     "Veikkausliiga Under 2.5 (1.90-2.20)",
        "tier":      "A",
    },
    "elite_under25": {
        "league":    "eliteserien",
        "model_src": "rule",
        "typ":       "Under 2.5",
        "condition": "odds_ft_under25 >= 2.20 and odds_ft_under25 <= 2.80",
        "odds_col":  "odds_ft_under25",
        "label":     "Eliteserien Under 2.5 (2.20-2.80)",
        "tier":      "B",
    },
    "allsv_under_corners": {
        "league":    "allsvenskan",
        "model_src": "rule",
        "typ":       "Under 9.5 corners",
        "condition": "odds_corners_under_95 >= 2.00",
        "odds_col":  "odds_corners_under_95",
        "label":     "Allsvenskan Under 9.5C (2.00+)",
        "tier":      "B",
    },
    "elite_under_corners": {
        "league":    "eliteserien",
